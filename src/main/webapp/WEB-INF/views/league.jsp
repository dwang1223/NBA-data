...
<body class="page page-id-12 page-template page-template-page-work-php page-template page-template-page-work-php" style="" data-twttr-rendered="true">
	...
	<div id="main">
		...
		<div class="row">
			<table class="league" border="1" width="1000">
				
				<tbody>
					<tr width="400">						
						<td>SouthWest Division</td>						
						<c:forEach items="${SWD}" var="team">
						<td>
							<a href="${pageContext.request.contextPath}/team/<c:out value="${team.id}"/>">
								<c:out value="${team.market}"/> <c:out value="${team.name}"/>
							</a>
						</td>
						</c:forEach>
					</tr>
