	...
	<div id="main">
		...
		<div>
			<table class="info">
				...
				<tbody>
					<tr>
						<td><c:out value="${playerInfo.first_name} ${playerInfo.last_name}" /></td>
						<td><c:out value="${playerInfo.abbr_name}" /></td>
						<td><c:out value="${playerInfo.weight}" /></td>
						<td><c:out value="${playerInfo.height}" /></td>
						<td><c:out value="${playerInfo.birthDate}" /></td>
						<td><c:out value="${playerInfo.postion}" /></td>
						<td><c:out value="${playerInfo.primary_position}" /></td>
						<td><c:out value="${playerInfo.jersey_number}" /></td>
						<td><c:out value="${playerInfo.birth_place}" /></td>
					</tr>
				</tbody>
			</table>
		</div>
		...
		<table class="info">
			...
			<tbody>
				<tr>
					<td><c:out value="${playerStat.games_played}" /></td>
					<td><c:out value="${playerStat.games_started}" /></td>
					<td><c:out value="${playerStat.minutes}" /></td>
					<td><c:out value="${playerStat.points}" /></td>
					<td><c:out value="${playerStat.field_goals_att}" /></td>
					<td><c:out value="${playerStat.field_goals_made}" /></td>
					<td><c:out value="${playerStat.three_points_att}" /></td>
					<td><c:out value="${playerStat.three_points_made}" /></td>
					<td><c:out value="${playerStat.free_throws_att}" /></td>
					<td><c:out value="${playerStat.free_throws_made}" /></td>
					<td><c:out value="${playerStat.offensive_rebounds}" /></td>
					<td><c:out value="${playerStat.defensive_rebounds}" /></td>
					<td><c:out value="${playerStat.rebounds}" /></td>
					<td><c:out value="${playerStat.assists}" /></td>
					<td><c:out value="${playerStat.steals}" /></td>
					<td><c:out value="${playerStat.blocks}" /></td>
					<td><c:out value="${playerStat.turnovers}" /></td>
					<td><c:out value="${playerStat.personal_fouls}" /></td>
